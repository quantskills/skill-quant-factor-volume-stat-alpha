---
name: quant-real-factor-5d-z-scored-price-volume-correlation
description: Use when computing the 5D Z-Scored Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Price Volume Correlation

Use this Skill to compute `5日标准化量价相关` / `5D Z-Scored Price Volume Correlation` from caller-provided OHLCV data.

...
`5日变化OBV斜率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量价` 类。

### 因子逻辑

```text
delta(obv_slope, window=5)
```
...
`5D Delta OBV Slope` is a real-data-validated framework-neutral OHLCV factor Skill in the `Price Volume` family.
...
- Usable rows: `195455`
- Coverage: `0.9925`
- 5-day Rank IC mean: `-0.012453`
- 5-day ICIR: `-0.4951`
- Quintile Q5-Q1 mean: `-0.001021`
- Top-quintile turnover: `0.6440`

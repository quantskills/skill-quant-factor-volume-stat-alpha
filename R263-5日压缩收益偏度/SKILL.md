---
name: quant-real-factor-5d-compressed-return-skewness
description: Use when computing the 5D Compressed Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Return Skewness

Use this Skill to compute `5日压缩收益偏度` / `5D Compressed Return Skewness` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-compressed-return-kurtosis
description: Use when computing the 5D Compressed Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Return Kurtosis

Use this Skill to compute `5日压缩收益峰度` / `5D Compressed Return Kurtosis` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-stability-scaled-price-volume-correlation
description: Use when computing the 10D Stability Scaled Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Price Volume Correlation

Use this Skill to compute `10日稳定度缩放量价相关` / `10D Stability Scaled Price Volume Correlation` from caller-provided OHLCV data.

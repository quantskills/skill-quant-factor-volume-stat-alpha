---
name: quant-real-factor-10d-z-scored-volume-expansion
description: Use when computing the 10D Z-Scored Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日标准化成交量放大` / `10D Z-Scored Volume Expansion` from caller-provided OHLCV data.

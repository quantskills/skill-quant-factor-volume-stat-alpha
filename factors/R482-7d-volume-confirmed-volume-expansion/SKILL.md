---
name: quant-real-factor-7d-volume-confirmed-volume-expansion
description: Use when computing the 7D Volume Confirmed Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Volume Expansion

Use this Skill to compute `7日量能确认成交量放大` / `7D Volume Confirmed Volume Expansion` from caller-provided OHLCV data.

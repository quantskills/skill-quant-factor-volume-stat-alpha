---
name: quant-real-factor-10d-stability-scaled-return-skewness
description: Use when computing the 10D Stability Scaled Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Return Skewness

Use this Skill to compute `10日稳定度缩放收益偏度` / `10D Stability Scaled Return Skewness` from caller-provided OHLCV data.

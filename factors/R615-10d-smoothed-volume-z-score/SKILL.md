---
name: quant-real-factor-10d-smoothed-volume-z-score
description: Use when computing the 10D Smoothed Volume Z-Score factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Volume Z-Score

Use this Skill to compute `10日平滑成交量标准分` / `10D Smoothed Volume Z-Score` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-compressed-dollar-volume-activity
description: Use when computing the 10D Compressed Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日压缩成交额活跃度` / `10D Compressed Dollar Volume Activity` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-smoothed-volume-expansion
description: Use when computing the 7D Smoothed Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Volume Expansion

Use this Skill to compute `7日平滑成交量放大` / `7D Smoothed Volume Expansion` from caller-provided OHLCV data.

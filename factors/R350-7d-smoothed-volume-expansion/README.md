...
`7日平滑成交量放大` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量能` 类。

### 因子逻辑

```text
smooth(volume_ratio, window=7)
```
...
- 可用行数: `195751`
- 覆盖率: `0.9940`
- 5日 Rank IC 均值: `0.003686`
- 5日 ICIR: `0.1546`
- 五分组 Q5-Q1 均值: `0.000856`
- Top 组换手: `0.4546`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Smoothed Volume Expansion` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volume` family.
...
- Usable rows: `195751`
- Coverage: `0.9940`
- 5-day Rank IC mean: `0.003686`
- 5-day ICIR: `0.1546`
- Quintile Q5-Q1 mean: `0.000856`

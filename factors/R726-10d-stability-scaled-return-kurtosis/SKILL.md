---
name: quant-real-factor-10d-stability-scaled-return-kurtosis
description: Use when computing the 10D Stability Scaled Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Return Kurtosis

Use this Skill to compute `10日稳定度缩放收益峰度` / `10D Stability Scaled Return Kurtosis` from caller-provided OHLCV data.

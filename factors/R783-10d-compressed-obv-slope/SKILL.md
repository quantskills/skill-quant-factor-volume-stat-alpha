---
name: quant-real-factor-10d-compressed-obv-slope
description: Use when computing the 10D Compressed OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed OBV Slope

Use this Skill to compute `10日压缩OBV斜率` / `10D Compressed OBV Slope` from caller-provided OHLCV data.

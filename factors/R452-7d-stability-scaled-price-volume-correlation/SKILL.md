---
name: quant-real-factor-7d-stability-scaled-price-volume-correlation
description: Use when computing the 7D Stability Scaled Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Price Volume Correlation

Use this Skill to compute `7日稳定度缩放量价相关` / `7D Stability Scaled Price Volume Correlation` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-volume-confirmed-obv-slope
description: Use when computing the 7D Volume Confirmed OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed OBV Slope

Use this Skill to compute `7日量能确认OBV斜率` / `7D Volume Confirmed OBV Slope` from caller-provided OHLCV data.

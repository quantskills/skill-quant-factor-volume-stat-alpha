---
name: quant-real-factor-7d-delta-return-skewness
description: Use when computing the 7D Delta Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Return Skewness

Use this Skill to compute `7日变化收益偏度` / `7D Delta Return Skewness` from caller-provided OHLCV data.

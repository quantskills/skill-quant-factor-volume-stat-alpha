---
name: quant-real-factor-10d-volatility-scaled-volume-z-score
description: Use when computing the 10D Volatility Scaled Volume Z-Score factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Volume Z-Score

Use this Skill to compute `10日波动缩放成交量标准分` / `10D Volatility Scaled Volume Z-Score` from caller-provided OHLCV data.

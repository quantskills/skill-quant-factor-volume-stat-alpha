---
name: quant-real-factor-5d-volatility-scaled-volume-expansion
description: Use when computing the 5D Volatility Scaled Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled Volume Expansion

Use this Skill to compute `5日波动缩放成交量放大` / `5D Volatility Scaled Volume Expansion` from caller-provided OHLCV data.

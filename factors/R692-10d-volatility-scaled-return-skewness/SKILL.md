---
name: quant-real-factor-10d-volatility-scaled-return-skewness
description: Use when computing the 10D Volatility Scaled Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Return Skewness

Use this Skill to compute `10日波动缩放收益偏度` / `10D Volatility Scaled Return Skewness` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-delta-return-kurtosis
description: Use when computing the 10D Delta Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Return Kurtosis

Use this Skill to compute `10日变化收益峰度` / `10D Delta Return Kurtosis` from caller-provided OHLCV data.

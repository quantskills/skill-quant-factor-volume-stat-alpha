---
name: quant-real-factor-7d-delta-volume-expansion
description: Use when computing the 7D Delta Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Volume Expansion

Use this Skill to compute `7日变化成交量放大` / `7D Delta Volume Expansion` from caller-provided OHLCV data.

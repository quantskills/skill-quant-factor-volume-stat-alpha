...
`7日平滑成交量时序排名` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `排序` 类。

### 因子逻辑

```text
smooth(ts_rank_volume, window=7)
```
...
`7D Smoothed Volume TS Rank` is a real-data-validated framework-neutral OHLCV factor Skill in the `Time Series Rank` family.
...
- Usable rows: `195751`
- Coverage: `0.9940`
- 5-day Rank IC mean: `0.004504`
- 5-day ICIR: `0.1988`
- Quintile Q5-Q1 mean: `0.001098`
- Top-quintile turnover: `0.4826`

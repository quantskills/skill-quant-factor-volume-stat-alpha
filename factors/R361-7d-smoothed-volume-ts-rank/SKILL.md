---
name: quant-real-factor-7d-smoothed-volume-ts-rank
description: Use when computing the 7D Smoothed Volume TS Rank factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Volume TS Rank

Use this Skill to compute `7日平滑成交量时序排名` / `7D Smoothed Volume TS Rank` from caller-provided OHLCV data.

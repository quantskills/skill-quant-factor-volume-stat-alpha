---
name: quant-real-factor-5d-delta-obv-slope
description: Use when computing the 5D Delta OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日变化OBV斜率` / `5D Delta OBV Slope` from caller-provided OHLCV data.

...
`5日量能确认OBV斜率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量价` 类。

### 因子逻辑

```text
confirm_volume(obv_slope, window=5)
```
...
`5D Volume Confirmed OBV Slope` is a real-data-validated framework-neutral OHLCV factor Skill in the `Price Volume` family.
...
- Usable rows: `195603`
- Coverage: `0.9932`
- 5-day Rank IC mean: `-0.003459`
- 5-day ICIR: `-0.1336`
- Quintile Q5-Q1 mean: `0.000318`
- Top-quintile turnover: `0.3887`

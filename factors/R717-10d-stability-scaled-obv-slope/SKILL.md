---
name: quant-real-factor-10d-stability-scaled-obv-slope
description: Use when computing the 10D Stability Scaled OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled OBV Slope

Use this Skill to compute `10日稳定度缩放OBV斜率` / `10D Stability Scaled OBV Slope` from caller-provided OHLCV data.

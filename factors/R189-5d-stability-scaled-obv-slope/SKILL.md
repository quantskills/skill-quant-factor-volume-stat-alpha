---
name: quant-real-factor-5d-stability-scaled-obv-slope
description: Use when computing the 5D Stability Scaled OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled OBV Slope

Use this Skill to compute `5日稳定度缩放OBV斜率` / `5D Stability Scaled OBV Slope` from caller-provided OHLCV data.

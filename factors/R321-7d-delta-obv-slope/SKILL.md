---
name: quant-real-factor-7d-delta-obv-slope
description: Use when computing the 7D Delta OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日变化OBV斜率` / `7D Delta OBV Slope` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-obv-slope
description: Use when computing the 10D Time-Series Ranked OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked OBV Slope

Use this Skill to compute `10日时序排名OBV斜率` / `10D Time-Series Ranked OBV Slope` from caller-provided OHLCV data.

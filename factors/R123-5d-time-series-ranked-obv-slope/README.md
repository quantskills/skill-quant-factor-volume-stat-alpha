...
`5日时序排名OBV斜率` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量价` 类。

### 因子逻辑

```text
rank(obv_slope, window=5)
```
...
- 可用行数: `195011`
- 覆盖率: `0.9902`
- 5日 Rank IC 均值: `-0.005073`
- 5日 ICIR: `-0.2030`
- 五分组 Q5-Q1 均值: `-0.000507`
- Top 组换手: `0.4118`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Time-Series Ranked OBV Slope` is a real-data-validated framework-neutral OHLCV factor Skill in the `Price Volume` family.
...
- Usable rows: `195011`
- Coverage: `0.9902`
- 5-day Rank IC mean: `-0.005073`
- 5-day ICIR: `-0.2030`
- Quintile Q5-Q1 mean: `-0.000507`
- Top-quintile turnover: `0.4118`

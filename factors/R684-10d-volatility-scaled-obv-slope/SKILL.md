---
name: quant-real-factor-10d-volatility-scaled-obv-slope
description: Use when computing the 10D Volatility Scaled OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled OBV Slope

Use this Skill to compute `10日波动缩放OBV斜率` / `10D Volatility Scaled OBV Slope` from caller-provided OHLCV data.

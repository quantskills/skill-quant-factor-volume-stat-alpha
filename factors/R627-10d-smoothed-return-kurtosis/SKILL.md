---
name: quant-real-factor-10d-smoothed-return-kurtosis
description: Use when computing the 10D Smoothed Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Return Kurtosis

Use this Skill to compute `10日平滑收益峰度` / `10D Smoothed Return Kurtosis` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-smoothed-price-volume-correlation
description: Use when computing the 10D Smoothed Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Price Volume Correlation

Use this Skill to compute `10日平滑量价相关` / `10D Smoothed Price Volume Correlation` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-smoothed-obv-slope
description: Use when computing the 5D Smoothed OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed OBV Slope

Use this Skill to compute `5日平滑OBV斜率` / `5D Smoothed OBV Slope` from caller-provided OHLCV data.

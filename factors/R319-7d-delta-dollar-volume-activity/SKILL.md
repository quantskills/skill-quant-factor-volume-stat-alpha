---
name: quant-real-factor-7d-delta-dollar-volume-activity
description: Use when computing the 7D Delta Dollar Volume Activity factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Dollar Volume Activity

Use this Skill to compute `7日变化成交额活跃度` / `7D Delta Dollar Volume Activity` from caller-provided OHLCV data.

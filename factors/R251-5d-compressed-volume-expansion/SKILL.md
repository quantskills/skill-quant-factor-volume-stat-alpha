---
name: quant-real-factor-5d-compressed-volume-expansion
description: Use when computing the 5D Compressed Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Volume Expansion

Use this Skill to compute `5日压缩成交量放大` / `5D Compressed Volume Expansion` from caller-provided OHLCV data.

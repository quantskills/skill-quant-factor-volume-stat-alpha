---
name: quant-real-factor-7d-smoothed-return-skewness
description: Use when computing the 7D Smoothed Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Return Skewness

Use this Skill to compute `7日平滑收益偏度` / `7D Smoothed Return Skewness` from caller-provided OHLCV data.

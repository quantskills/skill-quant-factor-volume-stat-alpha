---
name: quant-real-factor-10d-volume-confirmed-obv-slope
description: Use when computing the 10D Volume Confirmed OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed OBV Slope

Use this Skill to compute `10日量能确认OBV斜率` / `10D Volume Confirmed OBV Slope` from caller-provided OHLCV data.

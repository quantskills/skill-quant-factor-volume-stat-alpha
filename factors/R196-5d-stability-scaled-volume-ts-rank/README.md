...
`5日稳定度缩放成交量时序排名` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `排序` 类。

### 因子逻辑

```text
stability(ts_rank_volume, window=5)
```
...
`5D Stability Scaled Volume TS Rank` is a real-data-validated framework-neutral OHLCV factor Skill in the `Time Series Rank` family.
...
- Usable rows: `195455`
- Coverage: `0.9925`
- 5-day Rank IC mean: `0.003731`
- 5-day ICIR: `0.1745`
- Quintile Q5-Q1 mean: `0.000527`
- Top-quintile turnover: `0.7262`

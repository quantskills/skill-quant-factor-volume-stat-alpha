---
name: quant-real-factor-7d-smoothed-price-volume-correlation
description: Use when computing the 7D Smoothed Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Price Volume Correlation

Use this Skill to compute `7日平滑量价相关` / `7D Smoothed Price Volume Correlation` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-smoothed-price-volume-correlation
description: Use when computing the 5D Smoothed Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Price Volume Correlation

Use this Skill to compute `5日平滑量价相关` / `5D Smoothed Price Volume Correlation` from caller-provided OHLCV data.

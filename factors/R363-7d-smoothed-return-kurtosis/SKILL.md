---
name: quant-real-factor-7d-smoothed-return-kurtosis
description: Use when computing the 7D Smoothed Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed Return Kurtosis

Use this Skill to compute `7日平滑收益峰度` / `7D Smoothed Return Kurtosis` from caller-provided OHLCV data.

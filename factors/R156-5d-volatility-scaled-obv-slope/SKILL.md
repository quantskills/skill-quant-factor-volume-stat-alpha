---
name: quant-real-factor-5d-volatility-scaled-obv-slope
description: Use when computing the 5D Volatility Scaled OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volatility Scaled OBV Slope

Use this Skill to compute `5日波动缩放OBV斜率` / `5D Volatility Scaled OBV Slope` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-volatility-scaled-price-volume-correlation
description: Use when computing the 10D Volatility Scaled Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Price Volume Correlation

Use this Skill to compute `10日波动缩放量价相关` / `10D Volatility Scaled Price Volume Correlation` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-volume-confirmed-return-skewness
description: Use when computing the 10D Volume Confirmed Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Return Skewness

Use this Skill to compute `10日量能确认收益偏度` / `10D Volume Confirmed Return Skewness` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-z-scored-close-ts-rank
description: Use when computing the 10D Z-Scored Close TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Close TS Rank

Use this Skill to compute `10日标准化收盘时序排名` / `10D Z-Scored Close TS Rank` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-compressed-volume-z-score
description: Use when computing the 7D Compressed Volume Z-Score factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Volume Z-Score

Use this Skill to compute `7日压缩成交量标准分` / `7D Compressed Volume Z-Score` from caller-provided OHLCV data.

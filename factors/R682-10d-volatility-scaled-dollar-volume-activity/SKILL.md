---
name: quant-real-factor-10d-volatility-scaled-dollar-volume-activity
description: Use when computing the 10D Volatility Scaled Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Dollar Volume Activity

Use this Skill to compute `10日波动缩放成交额活跃度` / `10D Volatility Scaled Dollar Volume Activity` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-stability-scaled-obv-slope
description: Use when computing the 7D Stability Scaled OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled OBV Slope

Use this Skill to compute `7日稳定度缩放OBV斜率` / `7D Stability Scaled OBV Slope` from caller-provided OHLCV data.

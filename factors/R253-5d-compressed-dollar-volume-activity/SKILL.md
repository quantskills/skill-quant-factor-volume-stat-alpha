---
name: quant-real-factor-5d-compressed-dollar-volume-activity
description: Use when computing the 5D Compressed Dollar Volume Activity factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Dollar Volume Activity

Use this Skill to compute `5日压缩成交额活跃度` / `5D Compressed Dollar Volume Activity` from caller-provided OHLCV data.

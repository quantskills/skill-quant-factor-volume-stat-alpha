---
name: quant-real-factor-10d-volume-confirmed-volume-z-score
description: Use when computing the 10D Volume Confirmed Volume Z-Score factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Volume Z-Score

Use this Skill to compute `10日量能确认成交量标准分` / `10D Volume Confirmed Volume Z-Score` from caller-provided OHLCV data.

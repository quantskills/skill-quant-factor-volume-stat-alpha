---
name: quant-real-factor-5d-delta-volume-expansion
description: Use when computing the 5D Delta Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Volume Expansion

Use this Skill to compute `5日变化成交量放大` / `5D Delta Volume Expansion` from caller-provided OHLCV data.

...
`7日稳定度缩放收益峰度` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `分布` 类。

### 因子逻辑

```text
stability(ret_kurt, window=7)
```
...
`7D Stability Scaled Return Kurtosis` is a real-data-validated framework-neutral OHLCV factor Skill in the `Distribution` family.
...
- Usable rows: `195011`
- Coverage: `0.9902`
- 5-day Rank IC mean: `0.001756`
- 5-day ICIR: `0.1059`
- Quintile Q5-Q1 mean: `0.000239`
- Top-quintile turnover: `0.4300`

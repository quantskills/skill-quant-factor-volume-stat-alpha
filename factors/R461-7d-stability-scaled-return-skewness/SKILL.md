---
name: quant-real-factor-7d-stability-scaled-return-skewness
description: Use when computing the 7D Stability Scaled Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `7日稳定度缩放收益偏度` / `7D Stability Scaled Return Skewness` from caller-provided OHLCV data.

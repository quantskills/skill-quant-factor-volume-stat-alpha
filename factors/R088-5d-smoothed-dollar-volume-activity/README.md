...
`5日平滑成交额活跃度` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `流动性` 类。

### 因子逻辑

```text
smooth(dollar_volume, window=5)
```
...
- 可用行数: `195899`
- 覆盖率: `0.9947`
- 5日 Rank IC 均值: `0.004049`
- 5日 ICIR: `0.1697`
- 五分组 Q5-Q1 均值: `0.000977`
- Top 组换手: `0.5055`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Smoothed Dollar Volume Activity` is a real-data-validated framework-neutral OHLCV factor Skill in the `Liquidity` family.
...
- Usable rows: `195899`
- Coverage: `0.9947`
- 5-day Rank IC mean: `0.004049`
- 5-day ICIR: `0.1697`
- Quintile Q5-Q1 mean: `0.000977`
- Top-quintile turnover: `0.5055`

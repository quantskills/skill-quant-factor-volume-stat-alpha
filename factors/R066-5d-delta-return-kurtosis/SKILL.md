---
name: quant-real-factor-5d-delta-return-kurtosis
description: Use when computing the 5D Delta Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Return Kurtosis

Use this Skill to compute `5日变化收益峰度` / `5D Delta Return Kurtosis` from caller-provided OHLCV data.

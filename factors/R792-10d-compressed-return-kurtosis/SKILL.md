---
name: quant-real-factor-10d-compressed-return-kurtosis
description: Use when computing the 10D Compressed Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Return Kurtosis

Use this Skill to compute `10日压缩收益峰度` / `10D Compressed Return Kurtosis` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-volatility-scaled-obv-slope
description: Use when computing the 7D Volatility Scaled OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volatility Scaled OBV Slope

Use this Skill to compute `7日波动缩放OBV斜率` / `7D Volatility Scaled OBV Slope` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-delta-price-volume-correlation
description: Use when computing the 7D Delta Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Delta Price Volume Correlation

Use this Skill to compute `7日变化量价相关` / `7D Delta Price Volume Correlation` from caller-provided OHLCV data.

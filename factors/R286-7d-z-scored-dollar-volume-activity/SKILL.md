---
name: quant-real-factor-7d-z-scored-dollar-volume-activity
description: Use when computing the 7D Z-Scored Dollar Volume Activity factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Dollar Volume Activity

Use this Skill to compute `7日标准化成交额活跃度` / `7D Z-Scored Dollar Volume Activity` from caller-provided OHLCV data.

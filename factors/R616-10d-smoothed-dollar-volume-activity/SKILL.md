---
name: quant-real-factor-10d-smoothed-dollar-volume-activity
description: Use when computing the 10D Smoothed Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Dollar Volume Activity

Use this Skill to compute `10日平滑成交额活跃度` / `10D Smoothed Dollar Volume Activity` from caller-provided OHLCV data.

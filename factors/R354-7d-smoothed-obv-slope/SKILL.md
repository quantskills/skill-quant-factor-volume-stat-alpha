---
name: quant-real-factor-7d-smoothed-obv-slope
description: Use when computing the 7D Smoothed OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Smoothed OBV Slope

Use this Skill to compute `7日平滑OBV斜率` / `7D Smoothed OBV Slope` from caller-provided OHLCV data.

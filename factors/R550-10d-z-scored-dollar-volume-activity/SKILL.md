---
name: quant-real-factor-10d-z-scored-dollar-volume-activity
description: Use when computing the 10D Z-Scored Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Dollar Volume Activity

Use this Skill to compute `10日标准化成交额活跃度` / `10D Z-Scored Dollar Volume Activity` from caller-provided OHLCV data.

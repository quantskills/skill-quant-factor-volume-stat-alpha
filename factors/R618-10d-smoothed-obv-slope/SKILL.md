---
name: quant-real-factor-10d-smoothed-obv-slope
description: Use when computing the 10D Smoothed OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed OBV Slope

Use this Skill to compute `10日平滑OBV斜率` / `10D Smoothed OBV Slope` from caller-provided OHLCV data.

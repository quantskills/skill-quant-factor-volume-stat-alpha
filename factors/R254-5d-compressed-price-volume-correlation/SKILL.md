---
name: quant-real-factor-5d-compressed-price-volume-correlation
description: Use when computing the 5D Compressed Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Price Volume Correlation

Use this Skill to compute `5日压缩量价相关` / `5D Compressed Price Volume Correlation` from caller-provided OHLCV data.

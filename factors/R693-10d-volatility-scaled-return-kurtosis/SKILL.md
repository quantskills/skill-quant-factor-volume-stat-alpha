---
name: quant-real-factor-10d-volatility-scaled-return-kurtosis
description: Use when computing the 10D Volatility Scaled Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volatility Scaled Return Kurtosis

Use this Skill to compute `10日波动缩放收益峰度` / `10D Volatility Scaled Return Kurtosis` from caller-provided OHLCV data.

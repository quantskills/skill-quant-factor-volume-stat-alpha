---
name: quant-real-factor-10d-stability-scaled-volume-expansion
description: Use when computing the 10D Stability Scaled Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Volume Expansion

Use this Skill to compute `10日稳定度缩放成交量放大` / `10D Stability Scaled Volume Expansion` from caller-provided OHLCV data.

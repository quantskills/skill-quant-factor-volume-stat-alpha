---
name: quant-real-factor-5d-smoothed-return-skewness
description: Use when computing the 5D Smoothed Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Return Skewness

Use this Skill to compute `5日平滑收益偏度` / `5D Smoothed Return Skewness` from caller-provided OHLCV data.

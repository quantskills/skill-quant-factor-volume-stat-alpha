---
name: quant-real-factor-5d-volume-confirmed-price-volume-correlation
description: Use when computing the 5D Volume Confirmed Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Price Volume Correlation

Use this Skill to compute `5日量能确认量价相关` / `5D Volume Confirmed Price Volume Correlation` from caller-provided OHLCV data.

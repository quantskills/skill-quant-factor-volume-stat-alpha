---
name: quant-real-factor-10d-z-scored-return-kurtosis
description: Use when computing the 10D Z-Scored Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Return Kurtosis

Use this Skill to compute `10日标准化收益峰度` / `10D Z-Scored Return Kurtosis` from caller-provided OHLCV data.

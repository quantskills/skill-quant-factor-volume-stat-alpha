---
name: quant-real-factor-10d-time-series-ranked-close-ts-rank
description: Use when computing the 10D Time-Series Ranked Close TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Close TS Rank

Use this Skill to compute `10日时序排名收盘时序排名` / `10D Time-Series Ranked Close TS Rank` from caller-provided OHLCV data.

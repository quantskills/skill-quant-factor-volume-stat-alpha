---
name: quant-real-factor-5d-delta-price-volume-correlation
description: Use when computing the 5D Delta Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Price Volume Correlation

Use this Skill to compute `5日变化量价相关` / `5D Delta Price Volume Correlation` from caller-provided OHLCV data.

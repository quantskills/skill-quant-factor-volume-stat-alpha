...
`5日变化量价相关` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量价` 类。

### 因子逻辑

```text
delta(price_volume_corr, window=5)
```
...
- 可用行数: `195707`
- 覆盖率: `0.9938`
- 5日 Rank IC 均值: `-0.001391`
- 5日 ICIR: `-0.0730`
- 五分组 Q5-Q1 均值: `0.000180`
- Top 组换手: `0.7978`
- 无未来函数检查: `True`
- 状态: `pass`
...
`5D Delta Price Volume Correlation` is a real-data-validated framework-neutral OHLCV factor Skill in the `Price Volume` family.
...
- Usable rows: `195707`
- Coverage: `0.9938`
- 5-day Rank IC mean: `-0.001391`
- 5-day ICIR: `-0.0730`
- Quintile Q5-Q1 mean: `0.000180`
- Top-quintile turnover: `0.7978`

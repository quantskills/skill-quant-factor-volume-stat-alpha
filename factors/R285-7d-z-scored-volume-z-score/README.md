...
`7日标准化成交量标准分` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量能` 类。
...
`7D Z-Scored Volume Z-Score` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volume` family.
...
- Usable rows: `195307`
- Coverage: `0.9917`
- 5-day Rank IC mean: `0.000923`
- 5-day ICIR: `0.0406`
- Quintile Q5-Q1 mean: `0.000503`
- Top-quintile turnover: `0.6977`

---
name: quant-real-factor-10d-smoothed-volume-expansion
description: Use when computing the 10D Smoothed Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Volume Expansion

Use this Skill to compute `10日平滑成交量放大` / `10D Smoothed Volume Expansion` from caller-provided OHLCV data.

...
`7日量能确认量价相关` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量价` 类。

### 因子逻辑

```text
confirm_volume(price_volume_corr, window=7)
```
...
`7D Volume Confirmed Price Volume Correlation` is a real-data-validated framework-neutral OHLCV factor Skill in the `Price Volume` family.
...
- Usable rows: `195593`
- Coverage: `0.9932`
- 5-day Rank IC mean: `-0.020934`
- 5-day ICIR: `-0.8371`
- Quintile Q5-Q1 mean: `0.000714`
- Top-quintile turnover: `0.3373`

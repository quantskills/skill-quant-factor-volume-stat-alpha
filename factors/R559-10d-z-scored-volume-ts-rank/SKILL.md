---
name: quant-real-factor-10d-z-scored-volume-ts-rank
description: Use when computing the 10D Z-Scored Volume TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Volume TS Rank

Use this Skill to compute `10日标准化成交量时序排名` / `10D Z-Scored Volume TS Rank` from caller-provided OHLCV data.

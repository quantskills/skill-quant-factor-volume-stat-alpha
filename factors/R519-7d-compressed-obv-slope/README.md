...
`7日压缩OBV斜率` 是一个框架中立的 OHLCV 因子 Skill，属于 `量价` 类。它只依赖用户传入的行情字段，不绑定任何交易框架或数据供应商。

### 因子逻辑

```text
compress(obv_slope, window=7)
```
...
- 市场覆盖: `{"cn": 98, "us": 50}`
- 覆盖率: `0.9917`
- 5日 Rank IC 均值: `0.005768`
- 5日 ICIR: `0.2230`
- 五分组 Q5-Q1 均值: `0.001158`
- Top 组换手: `0.2899`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Compressed OBV Slope` is a framework-neutral OHLCV factor Skill in the `Price Volume` family. It depends only on caller-supplied market fields and is not tied to any trading framework or data vendor.
...
- Markets: `{"cn": 98, "us": 50}`
- Coverage: `0.9917`
- 5-day Rank IC mean: `0.005768`
- 5-day ICIR: `0.2230`
- Quintile Q5-Q1 mean: `0.001158`
- Top-quintile turnover: `0.2899`

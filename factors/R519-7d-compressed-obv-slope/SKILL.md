---
name: quant-real-factor-7d-compressed-obv-slope
description: Use when computing the 7D Compressed OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed OBV Slope

Use this Skill to compute `7日压缩OBV斜率` / `7D Compressed OBV Slope` from caller-provided OHLCV data.

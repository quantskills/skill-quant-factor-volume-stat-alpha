---
name: quant-real-factor-10d-z-scored-price-volume-correlation
description: Use when computing the 10D Z-Scored Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Price Volume Correlation

Use this Skill to compute `10日标准化量价相关` / `10D Z-Scored Price Volume Correlation` from caller-provided OHLCV data.

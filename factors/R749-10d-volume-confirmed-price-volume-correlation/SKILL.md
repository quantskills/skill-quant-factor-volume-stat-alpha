---
name: quant-real-factor-10d-volume-confirmed-price-volume-correlation
description: Use when computing the 10D Volume Confirmed Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Price Volume Correlation

Use this Skill to compute `10日量能确认量价相关` / `10D Volume Confirmed Price Volume Correlation` from caller-provided OHLCV data.

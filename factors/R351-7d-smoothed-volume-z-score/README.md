...
`7日平滑成交量标准分` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `量能` 类。

### 因子逻辑

```text
smooth(volume_z, window=7)
```
...
`7D Smoothed Volume Z-Score` is a real-data-validated framework-neutral OHLCV factor Skill in the `Volume` family.
...
- Usable rows: `195751`
- Coverage: `0.9940`
- 5-day Rank IC mean: `0.003408`
- 5-day ICIR: `0.1481`
- Quintile Q5-Q1 mean: `0.000972`
- Top-quintile turnover: `0.4900`

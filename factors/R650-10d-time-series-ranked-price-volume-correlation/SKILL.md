---
name: quant-real-factor-10d-time-series-ranked-price-volume-correlation
description: Use when computing the 10D Time-Series Ranked Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Price Volume Correlation

Use this Skill to compute `10日时序排名量价相关` / `10D Time-Series Ranked Price Volume Correlation` from caller-provided OHLCV data.

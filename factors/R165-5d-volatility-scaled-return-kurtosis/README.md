...
`5日波动缩放收益峰度` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `分布` 类。

### 因子逻辑

```text
vol_scaled(ret_kurt, window=5)
```
...
`5D Volatility Scaled Return Kurtosis` is a real-data-validated framework-neutral OHLCV factor Skill in the `Distribution` family.
...
- Usable rows: `195455`
- Coverage: `0.9925`
- 5-day Rank IC mean: `-0.002053`
- 5-day ICIR: `-0.1358`
- Quintile Q5-Q1 mean: `-0.000435`
- Top-quintile turnover: `0.5103`

---
name: quant-real-factor-10d-z-scored-return-skewness
description: Use when computing the 10D Z-Scored Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Z-Scored Return Skewness

Use this Skill to compute `10日标准化收益偏度` / `10D Z-Scored Return Skewness` from caller-provided OHLCV data.

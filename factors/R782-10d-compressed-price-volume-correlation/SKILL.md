---
name: quant-real-factor-10d-compressed-price-volume-correlation
description: Use when computing the 10D Compressed Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Price Volume Correlation

Use this Skill to compute `10日压缩量价相关` / `10D Compressed Price Volume Correlation` from caller-provided OHLCV data.

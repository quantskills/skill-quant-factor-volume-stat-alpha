---
name: quant-real-factor-10d-compressed-volume-expansion
description: Use when computing the 10D Compressed Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Volume Expansion

Use this Skill to compute `10日压缩成交量放大` / `10D Compressed Volume Expansion` from caller-provided OHLCV data.

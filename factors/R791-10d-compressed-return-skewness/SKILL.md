---
name: quant-real-factor-10d-compressed-return-skewness
description: Use when computing the 10D Compressed Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Return Skewness

Use this Skill to compute `10日压缩收益偏度` / `10D Compressed Return Skewness` from caller-provided OHLCV data.

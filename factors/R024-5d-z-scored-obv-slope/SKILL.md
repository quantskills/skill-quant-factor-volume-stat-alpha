---
name: quant-real-factor-5d-z-scored-obv-slope
description: Use when computing the 5D Z-Scored OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored OBV Slope

Use this Skill to compute `5日标准化OBV斜率` / `5D Z-Scored OBV Slope` from caller-provided OHLCV data.

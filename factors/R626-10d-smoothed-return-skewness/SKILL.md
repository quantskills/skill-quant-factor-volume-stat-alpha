---
name: quant-real-factor-10d-smoothed-return-skewness
description: Use when computing the 10D Smoothed Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Smoothed Return Skewness

Use this Skill to compute `10日平滑收益偏度` / `10D Smoothed Return Skewness` from caller-provided OHLCV data.

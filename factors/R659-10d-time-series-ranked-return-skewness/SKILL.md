---
name: quant-real-factor-10d-time-series-ranked-return-skewness
description: Use when computing the 10D Time-Series Ranked Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Return Skewness

Use this Skill to compute `10日时序排名收益偏度` / `10D Time-Series Ranked Return Skewness` from caller-provided OHLCV data.

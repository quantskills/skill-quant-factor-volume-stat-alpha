---
name: quant-real-factor-5d-smoothed-return-kurtosis
description: Use when computing the 5D Smoothed Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Smoothed Return Kurtosis

Use this Skill to compute `5日平滑收益峰度` / `5D Smoothed Return Kurtosis` from caller-provided OHLCV data.

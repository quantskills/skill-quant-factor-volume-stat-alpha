---
name: quant-real-factor-7d-stability-scaled-dollar-volume-activity
description: Use when computing the 7D Stability Scaled Dollar Volume Activity factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Dollar Volume Activity

Use this Skill to compute `7日稳定度缩放成交额活跃度` / `7D Stability Scaled Dollar Volume Activity` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-time-series-ranked-volume-expansion
description: Use when computing the 10D Time-Series Ranked Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Volume Expansion

Use this Skill to compute `10日时序排名成交量放大` / `10D Time-Series Ranked Volume Expansion` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-volume-confirmed-return-kurtosis
description: Use when computing the 10D Volume Confirmed Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Return Kurtosis

Use this Skill to compute `10日量能确认收益峰度` / `10D Volume Confirmed Return Kurtosis` from caller-provided OHLCV data.

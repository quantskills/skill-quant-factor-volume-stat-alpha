---
name: quant-real-factor-10d-z-scored-obv-slope
description: Use when computing the 10D Z-Scored OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日标准化OBV斜率` / `10D Z-Scored OBV Slope` from caller-provided OHLCV data.

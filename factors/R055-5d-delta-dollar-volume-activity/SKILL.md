---
name: quant-real-factor-5d-delta-dollar-volume-activity
description: Use when computing the 5D Delta Dollar Volume Activity factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Dollar Volume Activity

Use this Skill to compute `5日变化成交额活跃度` / `5D Delta Dollar Volume Activity` from caller-provided OHLCV data.

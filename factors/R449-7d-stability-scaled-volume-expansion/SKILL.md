---
name: quant-real-factor-7d-stability-scaled-volume-expansion
description: Use when computing the 7D Stability Scaled Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Stability Scaled Volume Expansion

Use this Skill to compute `7日稳定度缩放成交量放大` / `7D Stability Scaled Volume Expansion` from caller-provided OHLCV data.

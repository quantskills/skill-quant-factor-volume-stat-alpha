---
name: quant-real-factor-10d-delta-close-ts-rank
description: Use when computing the 10D Delta Close TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Close TS Rank

Use this Skill to compute `10日变化收盘时序排名` / `10D Delta Close TS Rank` from caller-provided OHLCV data.

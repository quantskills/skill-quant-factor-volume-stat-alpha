---
name: quant-real-factor-5d-stability-scaled-return-skewness
description: Use when computing the 5D Stability Scaled Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Return Skewness

Use this Skill to compute `5日稳定度缩放收益偏度` / `5D Stability Scaled Return Skewness` from caller-provided OHLCV data.

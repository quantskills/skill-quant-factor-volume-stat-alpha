---
name: quant-real-factor-7d-compressed-close-ts-rank
description: Use when computing the 7D Compressed Close TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Close TS Rank

Use this Skill to compute `7日压缩收盘时序排名` / `7D Compressed Close TS Rank` from caller-provided OHLCV data.

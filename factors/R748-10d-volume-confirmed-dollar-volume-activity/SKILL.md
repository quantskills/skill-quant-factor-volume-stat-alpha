---
name: quant-real-factor-10d-volume-confirmed-dollar-volume-activity
description: Use when computing the 10D Volume Confirmed Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Dollar Volume Activity

Use this Skill to compute `10日量能确认成交额活跃度` / `10D Volume Confirmed Dollar Volume Activity` from caller-provided OHLCV data.

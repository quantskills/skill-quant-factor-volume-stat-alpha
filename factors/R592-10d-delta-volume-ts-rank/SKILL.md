---
name: quant-real-factor-10d-delta-volume-ts-rank
description: Use when computing the 10D Delta Volume TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Volume TS Rank

Use this Skill to compute `10日变化成交量时序排名` / `10D Delta Volume TS Rank` from caller-provided OHLCV data.

...
`7日量能确认收益峰度` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `分布` 类。

### 因子逻辑

```text
confirm_volume(ret_kurt, window=7)
```
...
- 可用行数: `195603`
- 覆盖率: `0.9932`
- 5日 Rank IC 均值: `0.000393`
- 5日 ICIR: `0.0235`
- 五分组 Q5-Q1 均值: `-0.000232`
- Top 组换手: `0.4193`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Volume Confirmed Return Kurtosis` is a real-data-validated framework-neutral OHLCV factor Skill in the `Distribution` family.
...
- Usable rows: `195603`
- Coverage: `0.9932`
- 5-day Rank IC mean: `0.000393`
- 5-day ICIR: `0.0235`
- Quintile Q5-Q1 mean: `-0.000232`
- Top-quintile turnover: `0.4193`

---
name: quant-real-factor-7d-volume-confirmed-return-kurtosis
description: Use when computing the 7D Volume Confirmed Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Return Kurtosis

Use this Skill to compute `7日量能确认收益峰度` / `7D Volume Confirmed Return Kurtosis` from caller-provided OHLCV data.

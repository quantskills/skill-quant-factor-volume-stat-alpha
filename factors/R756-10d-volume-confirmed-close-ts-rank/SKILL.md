---
name: quant-real-factor-10d-volume-confirmed-close-ts-rank
description: Use when computing the 10D Volume Confirmed Close TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Close TS Rank

Use this Skill to compute `10日量能确认收盘时序排名` / `10D Volume Confirmed Close TS Rank` from caller-provided OHLCV data.

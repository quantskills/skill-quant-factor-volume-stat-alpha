---
name: quant-real-factor-5d-stability-scaled-volume-expansion
description: Use when computing the 5D Stability Scaled Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `5日稳定度缩放成交量放大` / `5D Stability Scaled Volume Expansion` from caller-provided OHLCV data.

...
`7日时序排名收益偏度` 是一个使用真实行情验证过的 OHLCV 因子 Skill，属于 `分布` 类。

### 因子逻辑

```text
rank(ret_skew, window=7)
```
...
- 可用行数: `195159`
- 覆盖率: `0.9910`
- 5日 Rank IC 均值: `0.002911`
- 5日 ICIR: `0.1570`
- 五分组 Q5-Q1 均值: `0.000624`
- Top 组换手: `0.4230`
- 无未来函数检查: `True`
- 状态: `pass`
...
`7D Time-Series Ranked Return Skewness` is a real-data-validated framework-neutral OHLCV factor Skill in the `Distribution` family.
...
- Usable rows: `195159`
- Coverage: `0.9910`
- 5-day Rank IC mean: `0.002911`
- 5-day ICIR: `0.1570`
- Quintile Q5-Q1 mean: `0.000624`

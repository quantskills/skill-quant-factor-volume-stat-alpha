---
name: quant-real-factor-10d-time-series-ranked-return-kurtosis
description: Use when computing the 10D Time-Series Ranked Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Time-Series Ranked Return Kurtosis

Use this Skill to compute `10日时序排名收益峰度` / `10D Time-Series Ranked Return Kurtosis` from caller-provided OHLCV data.

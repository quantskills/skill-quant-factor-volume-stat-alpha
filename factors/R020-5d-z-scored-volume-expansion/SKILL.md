---
name: quant-real-factor-5d-z-scored-volume-expansion
description: Use when computing the 5D Z-Scored Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Volume Expansion

Use this Skill to compute `5日标准化成交量放大` / `5D Z-Scored Volume Expansion` from caller-provided OHLCV data.

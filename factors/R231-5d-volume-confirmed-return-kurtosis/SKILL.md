---
name: quant-real-factor-5d-volume-confirmed-return-kurtosis
description: Use when computing the 5D Volume Confirmed Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Return Kurtosis

Use this Skill to compute `5日量能确认收益峰度` / `5D Volume Confirmed Return Kurtosis` from caller-provided OHLCV data.

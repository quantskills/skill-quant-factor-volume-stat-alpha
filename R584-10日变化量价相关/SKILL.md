---
name: quant-real-factor-10d-delta-price-volume-correlation
description: Use when computing the 10D Delta Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Price Volume Correlation

Use this Skill to compute `10日变化量价相关` / `10D Delta Price Volume Correlation` from caller-provided OHLCV data.

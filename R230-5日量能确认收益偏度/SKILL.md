---
name: quant-real-factor-5d-volume-confirmed-return-skewness
description: Use when computing the 5D Volume Confirmed Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed Return Skewness

Use this Skill to compute `5日量能确认收益偏度` / `5D Volume Confirmed Return Skewness` from caller-provided OHLCV data.

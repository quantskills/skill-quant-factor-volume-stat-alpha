---
name: quant-real-factor-5d-compressed-obv-slope
description: Use when computing the 5D Compressed OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed OBV Slope

Use this Skill to compute `5日压缩OBV斜率` / `5D Compressed OBV Slope` from caller-provided OHLCV data.

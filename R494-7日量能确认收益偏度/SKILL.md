---
name: quant-real-factor-7d-volume-confirmed-return-skewness
description: Use when computing the 7D Volume Confirmed Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Return Skewness

Use this Skill to compute `7日量能确认收益偏度` / `7D Volume Confirmed Return Skewness` from caller-provided OHLCV data.

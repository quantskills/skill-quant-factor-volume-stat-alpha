---
name: quant-real-factor-5d-delta-return-skewness
description: Use when computing the 5D Delta Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Delta Return Skewness

Use this Skill to compute `5日变化收益偏度` / `5D Delta Return Skewness` from caller-provided OHLCV data.

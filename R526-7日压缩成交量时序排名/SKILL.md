---
name: quant-real-factor-7d-compressed-volume-ts-rank
description: Use when computing the 7D Compressed Volume TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Volume TS Rank

Use this Skill to compute `7日压缩成交量时序排名` / `7D Compressed Volume TS Rank` from caller-provided OHLCV data.

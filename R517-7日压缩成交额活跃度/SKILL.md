---
name: quant-real-factor-7d-compressed-dollar-volume-activity
description: Use when computing the 7D Compressed Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Dollar Volume Activity

Use this Skill to compute `7日压缩成交额活跃度` / `7D Compressed Dollar Volume Activity` from caller-provided OHLCV data.

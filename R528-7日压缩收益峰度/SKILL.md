---
name: quant-real-factor-7d-compressed-return-kurtosis
description: Use when computing the 7D Compressed Return Kurtosis factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Return Kurtosis

Use this Skill to compute `7日压缩收益峰度` / `7D Compressed Return Kurtosis` from caller-provided OHLCV data.

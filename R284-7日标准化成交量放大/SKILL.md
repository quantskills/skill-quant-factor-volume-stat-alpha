---
name: quant-real-factor-7d-z-scored-volume-expansion
description: Use when computing the 7D Z-Scored Volume Expansion factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Volume Expansion

Use this Skill to compute `7日标准化成交量放大` / `7D Z-Scored Volume Expansion` from caller-provided OHLCV data.

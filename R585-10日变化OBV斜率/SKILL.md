---
name: quant-real-factor-10d-delta-obv-slope
description: Use when computing the 10D Delta OBV Slope factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
Use this Skill to compute `10日变化OBV斜率` / `10D Delta OBV Slope` from caller-provided OHLCV data.

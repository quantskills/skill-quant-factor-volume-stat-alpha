---
name: quant-real-factor-5d-stability-scaled-price-volume-correlation
description: Use when computing the 5D Stability Scaled Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Stability Scaled Price Volume Correlation

Use this Skill to compute `5日稳定度缩放量价相关` / `5D Stability Scaled Price Volume Correlation` from caller-provided OHLCV data.

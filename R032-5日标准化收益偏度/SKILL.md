---
name: quant-real-factor-5d-z-scored-return-skewness
description: Use when computing the 5D Z-Scored Return Skewness factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Z-Scored Return Skewness

Use this Skill to compute `5日标准化收益偏度` / `5D Z-Scored Return Skewness` from caller-provided OHLCV data.

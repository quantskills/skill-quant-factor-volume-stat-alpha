---
name: quant-real-factor-5d-volume-confirmed-obv-slope
description: Use when computing the 5D Volume Confirmed OBV Slope factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Volume Confirmed OBV Slope

Use this Skill to compute `5日量能确认OBV斜率` / `5D Volume Confirmed OBV Slope` from caller-provided OHLCV data.

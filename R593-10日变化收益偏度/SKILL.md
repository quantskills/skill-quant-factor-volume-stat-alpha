---
name: quant-real-factor-10d-delta-return-skewness
description: Use when computing the 10D Delta Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Delta Return Skewness

Use this Skill to compute `10日变化收益偏度` / `10D Delta Return Skewness` from caller-provided OHLCV data.

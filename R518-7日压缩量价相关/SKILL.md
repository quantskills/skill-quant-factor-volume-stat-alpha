---
name: quant-real-factor-7d-compressed-price-volume-correlation
description: Use when computing the 7D Compressed Price Volume Correlation factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Price Volume Correlation

Use this Skill to compute `7日压缩量价相关` / `7D Compressed Price Volume Correlation` from caller-provided OHLCV data.

---
name: quant-real-factor-5d-compressed-volume-z-score
description: Use when computing the 5D Compressed Volume Z-Score factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 5D Compressed Volume Z-Score

Use this Skill to compute `5日压缩成交量标准分` / `5D Compressed Volume Z-Score` from caller-provided OHLCV data.

---
name: quant-real-factor-7d-volume-confirmed-price-volume-correlation
description: Use when computing the 7D Volume Confirmed Price Volume Correlation factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Volume Confirmed Price Volume Correlation

Use this Skill to compute `7日量能确认量价相关` / `7D Volume Confirmed Price Volume Correlation` from caller-provided OHLCV data.

---
name: quant-real-factor-10d-stability-scaled-dollar-volume-activity
description: Use when computing the 10D Stability Scaled Dollar Volume Activity factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Stability Scaled Dollar Volume Activity

Use this Skill to compute `10日稳定度缩放成交额活跃度` / `10D Stability Scaled Dollar Volume Activity` from caller-provided OHLCV data.

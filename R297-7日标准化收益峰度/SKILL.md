---
name: quant-real-factor-7d-z-scored-return-kurtosis
description: Use when computing the 7D Z-Scored Return Kurtosis factor from user-supplied real OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Z-Scored Return Kurtosis

Use this Skill to compute `7日标准化收益峰度` / `7D Z-Scored Return Kurtosis` from caller-provided OHLCV data.

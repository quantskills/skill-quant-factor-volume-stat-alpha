---
name: quant-real-factor-10d-volume-confirmed-volume-expansion
description: Use when computing the 10D Volume Confirmed Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Volume Confirmed Volume Expansion

Use this Skill to compute `10日量能确认成交量放大` / `10D Volume Confirmed Volume Expansion` from caller-provided OHLCV data.

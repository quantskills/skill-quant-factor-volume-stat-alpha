---
name: quant-real-factor-7d-compressed-volume-expansion
description: Use when computing the 7D Compressed Volume Expansion factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Volume Expansion

Use this Skill to compute `7日压缩成交量放大` / `7D Compressed Volume Expansion` from caller-provided OHLCV data.

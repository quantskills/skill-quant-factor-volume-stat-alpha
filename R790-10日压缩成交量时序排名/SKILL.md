---
name: quant-real-factor-10d-compressed-volume-ts-rank
description: Use when computing the 10D Compressed Volume TS Rank factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 10D Compressed Volume TS Rank

Use this Skill to compute `10日压缩成交量时序排名` / `10D Compressed Volume TS Rank` from caller-provided OHLCV data.

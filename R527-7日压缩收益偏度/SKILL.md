---
name: quant-real-factor-7d-compressed-return-skewness
description: Use when computing the 7D Compressed Return Skewness factor from user-supplied OHLCV data or reviewing its bundled real-data validation metrics.
metadata:
...
# 7D Compressed Return Skewness

Use this Skill to compute `7日压缩收益偏度` / `7D Compressed Return Skewness` from caller-provided OHLCV data.
